...
// bool isSafe(int newX, int newY, vector<vector<bool>> & isVisited,
// vector<vector<int>> & arr, int n) {
//     if((newX >= 0 && newX < n) && (newY >= 0 && newY < n) &&
//     isVisited[newX][newY] == false && arr[newX][newY] != 0)
//         return true;
//     return false;
// }
// void solve(int x, int y, vector<vector<int>> & arr, int n, vector<string> &
// ans, vector<vector<bool>> & isVisited, string path) {
//     if(x == n - 1 && y == n - 1)
//     {
//         ans.push_back(path);
//         return;
