...
// Q1) Implement a Phone Directory:
...
//     void printSuggestions(TrieNode* current, vector<string> &temp, string
//     prefix){
...
// vector<vector<string>> phoneDirectory(vector<string>&contactList, string
// &queryStr){
//     Trie *t = new Trie();
